...
local petHpWidth = ns.AddSetSlider(ConFrame8,8,L["宠物血条宽度"],L["宠物血条宽度鼠标提示"],-30,50,1,"%d","petHpWidth",ns.SetPoints)
...
local petSelectedScale = ns.AddSetSlider(ConFrame8,8,L["选中时宠物缩放"],L["选中时宠物缩放鼠标提示"],0.5,2,0.05,"%.2f","petSelectedScale",ns.SetPoints)
